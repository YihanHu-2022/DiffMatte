...
class ResNet_D(Backbone):
    ...
    def __init__(self, block, in_channels, layers, norm_layer=None, late_downsample=False):
        ...
        self.conv1 = SpectralNorm(nn.Conv2d(in_channels, 32, kernel_size=3,
    ...
    def forward(self, x):
        ...
        return x # 增加一层upsample


if __name__ == "__main__":
    m = ResNet_D(BasicBlock, 6, [3, 4, 4, 2])
    print(m)
    out = m(torch.ones(2,6,512,512))
    print(out[0].shape) # torch.Size([2, 512, 16, 16])
